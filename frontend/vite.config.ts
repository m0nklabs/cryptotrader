...
// FastAPI backend defaults to port 8000 (see docs/PORTS.md). Legacy helper script ran on 8787.
...
// Disable SSL verification only when explicitly opted-in for self-signed certs.
