...
class SignalGenerator:
    ...
    def analyze_all(self) -> Dict:
        ...
        logger.debug(f"✅ Analysis complete: {overall['signal']} ({overall['strength']}% strength, {overall['confidence']}% confidence)")
...
def quick_analysis(prices: List[float], volumes: Optional[List[float]] = None, 
...
if __name__ == "__main__":
    ...
    prices = [
        100, 101, 99, 102, 103, 105, 104, 106, 108, 107,
        109, 111, 110, 112, 114, 113, 115, 117, 116, 118,
        120, 119, 121, 123, 122, 124, 126, 125, 127, 129,
        128, 130, 132, 131, 133, 135, 134, 136, 138, 137,
        139, 141, 140, 138, 136, 134, 132, 130, 128, 126
    ]
